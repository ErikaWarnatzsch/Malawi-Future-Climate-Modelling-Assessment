...
def main():
    ...
    UDel.units = Unit('Celsius') # This fixes UDEl which is in 'degC' to read 'Celsius'
    ...
    UDel = UDel.aggregated_by('year', iris.analysis.MEAN)
    ...
    UDel_mean = UDel_mean.collapsed(['time'], iris.analysis.MEAN)     
    
    #create average of observed baseline data
    Obs = (CRU_mean + UDel_mean)/2
    ...
    #PART 7: PRINT DATA
    import csv
    with open('output_Tasdata.csv', 'wb') as csvfile:
        writer = csv.writer(csvfile, delimiter=',')
        
        writer.writerow(['Parameter', 'Means'])
        
     #PART 7A: WRITE RCP 4.5 DATA
