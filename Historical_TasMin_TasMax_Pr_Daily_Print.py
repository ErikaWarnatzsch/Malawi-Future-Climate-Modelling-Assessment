...
def main():
    ...
    #Convert units to match, CORDEX data in precipitation_flux (kg m-2 s-1) but want all data in precipitation rate (mm day-1).
    #Since 1 kg of rain spread over 1 m of surface is 1mm in thickness, and there are 60*60*24=86400 seconds in a day, the conversion is:
    Convert=86400
    ...
    #Convert units to match, CRU and GPCC data in mm per month but want precipitation rate in mm per day. Since there are 12 months in a year and 365.25 days in a year, the conversion is:
    Convert = 12/365.25
    CRU_pr = CRU_pr*Convert
    GPCC_pr = GPCC_pr*Convert   
    
    #Convert units to match, UDel data in cm per month but want precipitation rate in mm per day. Since there are 12 months in the year, 365.25 days in the year, and 10mm in a cm, the conversion is:
    Convert=10*12/365.25
    UDel_pr = UDel_pr*Convert
    
    #rename units to make names match after conversion
    CRU_pr.units = Unit('mm per day')
    UDel_pr.units = Unit('mm per day')
    GPCC_pr.units = Unit('mm per day')
    ...
    iriscc.add_day_of_year(CCCmaCanRCM_tasmin, 'time')
    iriscc.add_day_of_year(CCCmaSMHI_tasmin, 'time')
    iriscc.add_day_of_year(CNRM_tasmin, 'time')
    iriscc.add_day_of_year(CNRMSMHI_tasmin, 'time')
    iriscc.add_day_of_year(CSIRO_tasmin, 'time')
    iriscc.add_day_of_year(ICHECDMI_tasmin, 'time')
    iriscc.add_day_of_year(ICHECCCLM_tasmin, 'time')
    iriscc.add_day_of_year(ICHECKNMI_tasmin, 'time')
    iriscc.add_day_of_year(ICHECMPI_tasmin, 'time')
    iriscc.add_day_of_year(ICHECSMHI_tasmin, 'time')
    iriscc.add_day_of_year(IPSL_tasmin, 'time')
    iriscc.add_day_of_year(MIROC_tasmin, 'time')
    iriscc.add_day_of_year(MOHCCCLM_tasmin, 'time')
    iriscc.add_day_of_year(MOHCKNMI_tasmin, 'time')
    iriscc.add_day_of_year(MOHCSMHI_tasmin, 'time')
    iriscc.add_day_of_year(MPICCLM_tasmin, 'time')
    iriscc.add_day_of_year(MPIREMO_tasmin, 'time')
    iriscc.add_day_of_year(MPISMHI_tasmin, 'time')
    iriscc.add_day_of_year(NCCSMHI_tasmin, 'time')
    iriscc.add_day_of_year(NOAA_tasmin, 'time')
    
    iriscc.add_day_of_year(CCCmaCanRCM_tasmax, 'time')
    iriscc.add_day_of_year(CCCmaSMHI_tasmax, 'time')
    iriscc.add_day_of_year(CNRM_tasmax, 'time')
    iriscc.add_day_of_year(CNRMSMHI_tasmax, 'time')
    iriscc.add_day_of_year(CSIRO_tasmax, 'time')
    iriscc.add_day_of_year(ICHECDMI_tasmax, 'time')
    iriscc.add_day_of_year(ICHECCCLM_tasmax, 'time')
    iriscc.add_day_of_year(ICHECKNMI_tasmax, 'time')
    iriscc.add_day_of_year(ICHECMPI_tasmax, 'time')
    iriscc.add_day_of_year(ICHECSMHI_tasmax, 'time')
    iriscc.add_day_of_year(IPSL_tasmax, 'time')
    iriscc.add_day_of_year(MIROC_tasmax, 'time')
    iriscc.add_day_of_year(MOHCCCLM_tasmax, 'time')
    iriscc.add_day_of_year(MOHCKNMI_tasmax, 'time')
    iriscc.add_day_of_year(MOHCSMHI_tasmax, 'time')
    iriscc.add_day_of_year(MPICCLM_tasmax, 'time')
    iriscc.add_day_of_year(MPIREMO_tasmax, 'time')
    iriscc.add_day_of_year(MPISMHI_tasmax, 'time')
    iriscc.add_day_of_year(NCCSMHI_tasmax, 'time')
    iriscc.add_day_of_year(NOAA_tasmax, 'time')
    
    iriscc.add_day_of_year(CCCmaCanRCM_pr, 'time')
    iriscc.add_day_of_year(CCCmaSMHI_pr, 'time')
    iriscc.add_day_of_year(CNRM_pr, 'time')
    iriscc.add_day_of_year(CNRMSMHI_pr, 'time')
    iriscc.add_day_of_year(CSIRO_pr, 'time')
    iriscc.add_day_of_year(ICHECDMI_pr, 'time')
    iriscc.add_day_of_year(ICHECCCLM_pr, 'time')
    iriscc.add_day_of_year(ICHECKNMI_pr, 'time')
    iriscc.add_day_of_year(ICHECMPI_pr, 'time')
    iriscc.add_day_of_year(ICHECSMHI_pr, 'time')
    iriscc.add_day_of_year(IPSL_pr, 'time')
    iriscc.add_day_of_year(MIROC_pr, 'time')
    iriscc.add_day_of_year(MOHCCCLM_pr, 'time')
    iriscc.add_day_of_year(MOHCKNMI_pr, 'time')
    iriscc.add_day_of_year(MOHCSMHI_pr, 'time')
    iriscc.add_day_of_year(MPICCLM_pr, 'time')
    iriscc.add_day_of_year(MPIREMO_pr, 'time')
    iriscc.add_day_of_year(MPISMHI_pr, 'time')
    iriscc.add_day_of_year(NCCSMHI_pr, 'time')
    iriscc.add_day_of_year(NOAA_pr, 'time')
    
    iriscc.add_day_of_year(CRU_tasmin, 'time')
    iriscc.add_day_of_year(CRU_tasmax, 'time')
    iriscc.add_day_of_year(CRU_pr, 'time')
    iriscc.add_day_of_year(UDel_pr, 'time')
    iriscc.add_day_of_year(GPCC_pr, 'time')
    ...
    CCCmaCanRCM_tasmin = CCCmaCanRCM_tasmin.aggregated_by('day_of_year', iris.analysis.MEAN)
    CCCmaSMHI_tasmin = CCCmaSMHI_tasmin.aggregated_by('day_of_year', iris.analysis.MEAN)
    CNRM_tasmin = CNRM_tasmin.aggregated_by('day_of_year', iris.analysis.MEAN)
    CNRMSMHI_tasmin = CNRMSMHI_tasmin.aggregated_by('day_of_year', iris.analysis.MEAN)
    CSIRO_tasmin = CSIRO_tasmin.aggregated_by('day_of_year', iris.analysis.MEAN)
    ICHECDMI_tasmin = ICHECDMI_tasmin.aggregated_by('day_of_year', iris.analysis.MEAN)
    ICHECCCLM_tasmin = ICHECCCLM_tasmin.aggregated_by('day_of_year', iris.analysis.MEAN)
    ICHECKNMI_tasmin = ICHECKNMI_tasmin.aggregated_by('day_of_year', iris.analysis.MEAN)
    ICHECMPI_tasmin = ICHECMPI_tasmin.aggregated_by('day_of_year', iris.analysis.MEAN)
    ICHECSMHI_tasmin = ICHECSMHI_tasmin.aggregated_by('day_of_year', iris.analysis.MEAN)
    IPSL_tasmin = IPSL_tasmin.aggregated_by('day_of_year', iris.analysis.MEAN)
    MIROC_tasmin = MIROC_tasmin.aggregated_by('day_of_year', iris.analysis.MEAN)
    MOHCCCLM_tasmin = MOHCCCLM_tasmin.aggregated_by('day_of_year', iris.analysis.MEAN)
    MOHCKNMI_tasmin = MOHCKNMI_tasmin.aggregated_by('day_of_year', iris.analysis.MEAN)
    MOHCSMHI_tasmin = MOHCSMHI_tasmin.aggregated_by('day_of_year', iris.analysis.MEAN)
    MPICCLM_tasmin = MPICCLM_tasmin.aggregated_by('day_of_year', iris.analysis.MEAN)
    MPIREMO_tasmin = MPIREMO_tasmin.aggregated_by('day_of_year', iris.analysis.MEAN)
    MPISMHI_tasmin = MPISMHI_tasmin.aggregated_by('day_of_year', iris.analysis.MEAN)
    NCCSMHI_tasmin = NCCSMHI_tasmin.aggregated_by('day_of_year', iris.analysis.MEAN)
    NOAA_tasmin = NOAA_tasmin.aggregated_by('day_of_year', iris.analysis.MEAN)
    
    CCCmaCanRCM_tasmax = CCCmaCanRCM_tasmax.aggregated_by('day_of_year', iris.analysis.MEAN)
    CCCmaSMHI_tasmax = CCCmaSMHI_tasmax.aggregated_by('day_of_year', iris.analysis.MEAN)
    CNRM_tasmax = CNRM_tasmax.aggregated_by('day_of_year', iris.analysis.MEAN)
    CNRMSMHI_tasmax = CNRMSMHI_tasmax.aggregated_by('day_of_year', iris.analysis.MEAN)
    CSIRO_tasmax = CSIRO_tasmax.aggregated_by('day_of_year', iris.analysis.MEAN)
    ICHECDMI_tasmax = ICHECDMI_tasmax.aggregated_by('day_of_year', iris.analysis.MEAN)
    ICHECCCLM_tasmax = ICHECCCLM_tasmax.aggregated_by('day_of_year', iris.analysis.MEAN)
    ICHECKNMI_tasmax = ICHECKNMI_tasmax.aggregated_by('day_of_year', iris.analysis.MEAN)
    ICHECMPI_tasmax = ICHECMPI_tasmax.aggregated_by('day_of_year', iris.analysis.MEAN)
    ICHECSMHI_tasmax = ICHECSMHI_tasmax.aggregated_by('day_of_year', iris.analysis.MEAN)
    IPSL_tasmax = IPSL_tasmax.aggregated_by('day_of_year', iris.analysis.MEAN)
    MIROC_tasmax = MIROC_tasmax.aggregated_by('day_of_year', iris.analysis.MEAN)
    MOHCCCLM_tasmax = MOHCCCLM_tasmax.aggregated_by('day_of_year', iris.analysis.MEAN)
    MOHCKNMI_tasmax = MOHCKNMI_tasmax.aggregated_by('day_of_year', iris.analysis.MEAN)
    MOHCSMHI_tasmax = MOHCSMHI_tasmax.aggregated_by('day_of_year', iris.analysis.MEAN)
    MPICCLM_tasmax = MPICCLM_tasmax.aggregated_by('day_of_year', iris.analysis.MEAN)
    MPIREMO_tasmax = MPIREMO_tasmax.aggregated_by('day_of_year', iris.analysis.MEAN)
    MPISMHI_tasmax = MPISMHI_tasmax.aggregated_by('day_of_year', iris.analysis.MEAN)
    NCCSMHI_tasmax = NCCSMHI_tasmax.aggregated_by('day_of_year', iris.analysis.MEAN)
    NOAA_tasmax = NOAA_tasmax.aggregated_by('day_of_year', iris.analysis.MEAN)
    
    CCCmaCanRCM_pr = CCCmaCanRCM_pr.aggregated_by('day_of_year', iris.analysis.MEAN)
    CCCmaSMHI_pr = CCCmaSMHI_pr.aggregated_by('day_of_year', iris.analysis.MEAN)
    CNRM_pr = CNRM_pr.aggregated_by('day_of_year', iris.analysis.MEAN)
    CNRMSMHI_pr = CNRMSMHI_pr.aggregated_by('day_of_year', iris.analysis.MEAN)
    CSIRO_pr = CSIRO_pr.aggregated_by('day_of_year', iris.analysis.MEAN)
    ICHECDMI_pr = ICHECDMI_pr.aggregated_by('day_of_year', iris.analysis.MEAN)
    ICHECCCLM_pr = ICHECCCLM_pr.aggregated_by('day_of_year', iris.analysis.MEAN)
    ICHECKNMI_pr = ICHECKNMI_pr.aggregated_by('day_of_year', iris.analysis.MEAN)
    ICHECMPI_pr = ICHECMPI_pr.aggregated_by('day_of_year', iris.analysis.MEAN)
    ICHECSMHI_pr = ICHECSMHI_pr.aggregated_by('day_of_year', iris.analysis.MEAN)
    IPSL_pr = IPSL_pr.aggregated_by('day_of_year', iris.analysis.MEAN)
    MIROC_pr = MIROC_pr.aggregated_by('day_of_year', iris.analysis.MEAN)
    MOHCCCLM_pr = MOHCCCLM_pr.aggregated_by('day_of_year', iris.analysis.MEAN)
    MOHCKNMI_pr = MOHCKNMI_pr.aggregated_by('day_of_year', iris.analysis.MEAN)
    MOHCSMHI_pr = MOHCSMHI_pr.aggregated_by('day_of_year', iris.analysis.MEAN)
    MPICCLM_pr = MPICCLM_pr.aggregated_by('day_of_year', iris.analysis.MEAN)
    MPIREMO_pr = MPIREMO_pr.aggregated_by('day_of_year', iris.analysis.MEAN)
    MPISMHI_pr = MPISMHI_pr.aggregated_by('day_of_year', iris.analysis.MEAN)
    NCCSMHI_pr = NCCSMHI_pr.aggregated_by('day_of_year', iris.analysis.MEAN)
    NOAA_pr = NOAA_pr.aggregated_by('day_of_year', iris.analysis.MEAN)
    
    CRU_tasmin = CRU_tasmin.aggregated_by('day_of_year', iris.analysis.MEAN)
    CRU_tasmax = CRU_tasmax.aggregated_by('day_of_year', iris.analysis.MEAN)
    CRU_pr = CRU_pr.aggregated_by('day_of_year', iris.analysis.MEAN)
    UDel_pr = UDel_pr.aggregated_by('day_of_year', iris.analysis.MEAN)
    GPCC_pr = GPCC_pr.aggregated_by('day_of_year', iris.analysis.MEAN)
    ...
    #PART 5: PRINT DATA
    import csv
    with open('output_Historical_daily_Tasmin_Tasmax_Pr.csv', 'wb') as csvfile:
